//Se crea la primera variable, llamda cifrado,que contiene la funcion frase//
var cipher = function(phrase){
//Creamos una variable llamada tabla de valores//
var chartValue = 0;
var cipherPhrase ='';
//Aplicamos un for para recorrer cada letra que el usuario ha ingresado//
...
console.log(cipher(prompt("Escribe una frase")))
console.log(deCipher(prompt("DECIFRADO")))
